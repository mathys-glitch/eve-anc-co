          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_1.2fr] gap-16 mb-14">
            ...
            <div>
              ...
              <div className="flex items-center gap-5">
                ...
                {/* TikTok */}
                <a href="https://www.tiktok.com/@eveandco" target="_blank" rel="noopener noreferrer" className="text-deep hover:text-terra transition-colors">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@eveandco" target="_blank" rel="noopener noreferrer" className="text-deep hover:text-terra transition-colors">
